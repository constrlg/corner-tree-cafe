...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Admin - Other Items</title>
  </head>
  <body>
    ...
    <section id="insert_food_item">
        <div class="container">
            <div class="insert_food_item_content">
                ...
                <h1 class="food_category_title">Other Items</h1>
                ...
                <div class="inserted_food_item_list">
                    <table class="table">
                        ...
                        <tbody>
                            <?php 
                                include("conn.php");
                                $pic = mysqli_query($conn, "SELECT * FROM `other_items`");
                                while($row = mysqli_fetch_array($pic)) {
                                    echo "
                                        <tr>
                                            ...
                                            <td><a href='other_items_delete_food_item.php? id=$row[id]' class='delete_food_item_btn'>Delete</a></td>
                                            <td><a href='other_items_update_food_item_form.php? id=$row[id]' class='update_food_item_btn'>Update</a></td>
                                            </tr>
                                    ";
                                }
                            ?>
            ...
            <div class="food_insert_item_form">
                <div class="container">
                    <div class="food_insert_item_form_content">
                        ...
                        <form method="POST" action="other_items_insert_food_item.php" enctype="multipart/form-data">
