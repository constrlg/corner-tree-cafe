<?php 
    ...
    if(isset($_POST['insert_food_item'])) {
        ...
        mysqli_query($conn, "INSERT INTO `other_items`(`food_item_img`, `food_item_name`, `food_item_description`, `food_item_price`) VALUES ('$img_des','$food_item_name','$food_item_description','$food_item_price')");
