...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Other Items</title>
  </head>
  <body>
    ...
    <section id="menu_wrapper">
        <div class="container">
            <div class="menu_content">
                <h1 class="menu_title">Menu - Other Items</h1>
                    ...
                    <p id="ps">(*order at least a day in advance but also check if we have any readily available)</p>
            </div>
        </div>
    </section>
