...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Pinoy Dishes</title>
  </head>
  <body>
    ...
    <section id="menu_wrapper">
        <div class="container">
            <div class="menu_content">
                <h1 class="menu_title">Menu - Pinoy Dishes</h1>
                    ...
                    <p id="ps">V - VEGAN (no eggs, no dairy), VO - Vegan Option (please inform waiter), GF – Gluten-free</p>
            </div>
        </div>
    </section>
