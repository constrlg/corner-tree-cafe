...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Desserts</title>
  </head>
  <body>
    ...
    <section id="menu_wrapper">
        <div class="container">
            <div class="menu_content">
                <h1 class="menu_title">Menu - Desserts</h1>
                    ...
                    <p id="ps">V - VEGAN (No eggs, no dairy), SF - Sugarfree (no added sugar), GF – Gluten-free<br> * Isomalt, a natural ingredient from sugar beets is used to sweeten the sugarfree  (SF) desserts (diabetics can now enjoy!)</p>
            </div>
        </div>
    </section>
