...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Admin - Sides Update</title>
  </head>
  <body>
  ...
  <?php 
        include("conn.php");
        $ID = $_GET['id'];
        $Record = mysqli_query($conn, "SELECT * FROM `sides` WHERE id = $ID");
                        ...
                        <section id="food_update_item_form">
                            <div class="container">
                                ...
                                <div class="food_update_item_form_content">
                                    <form method="POST" action="sides_update_food_item.php" enctype="multipart/form-data">
