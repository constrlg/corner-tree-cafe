...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Soups</title>
  </head>
  <body>
    ...
    <section id="menu_wrapper">
        <div class="container">
            <div class="menu_content">
                <h1 class="menu_title">Menu - Soups</h1>
                    ...
                    <p id="ps">All come with whole wheat breadstick (breadstick not vegan)<br> V - VEGAN (no eggs, no dairy), VO - Vegan Option (please inform waiter)</p>
            </div>
        </div>
    </section>
