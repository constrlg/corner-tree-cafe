<?php 
    ...
    if(isset($_POST['update_food_item'])) {
        ...
        mysqli_query($conn, "UPDATE `soups` SET `food_item_img`='$img_des',`food_item_name`='$food_item_name',`food_item_description`='$food_item_description',`food_item_price`='$food_item_price' WHERE id = $ID");
