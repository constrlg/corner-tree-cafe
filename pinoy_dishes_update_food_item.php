<?php 
    ...
    if(isset($_POST['update_food_item'])) {
        ...
        $img_des = "pinoy_dishes/".$img_name;
        move_uploaded_file($img_loc, 'pinoy_dishes/'.$img_name);
        ...
        mysqli_query($conn, "UPDATE `pinoy_dishes` SET `food_item_img`='$img_des',`food_item_name`='$food_item_name',`food_item_description`='$food_item_description',`food_item_price`='$food_item_price' WHERE id = $ID");
