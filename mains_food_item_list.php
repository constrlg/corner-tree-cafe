...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Admin - Mains</title>
  </head>
  <body>
    ...
    <section id="insert_food_item">
        <div class="container">
            <div class="insert_food_item_content">
                ...
                <h1 class="food_category_title">Mains</h1>
                ...
                <div class="inserted_food_item_list">
                    <table class="table">
                        ...
                        <tbody>
                            <?php 
                                include("conn.php");
                                $pic = mysqli_query($conn, "SELECT * FROM `mains`");
                                while($row = mysqli_fetch_array($pic)) {
                                    echo "
                                        <tr>
                                            ...
                                            <td><a href='mains_delete_food_item.php? id=$row[id]' class='delete_food_item_btn'>Delete</a></td>
                                            <td><a href='mains_update_food_item_form.php? id=$row[id]' class='update_food_item_btn'>Update</a></td>
                                            </tr>
                                    ";
                                }
                            ?>
            ...
            <div class="food_insert_item_form">
                <div class="container">
                    <div class="food_insert_item_form_content">
                        ...
                        <form method="POST" action="mains_insert_food_item.php" enctype="multipart/form-data">
