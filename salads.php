...
<html lang="en">
  <head>
    ...
    <title>Corner Tree Cafe: Salads</title>
  </head>
  <body>
    ...
    <section id="menu_wrapper">
        <div class="container">
            <div class="menu_content">
                <h1 class="menu_title">Menu - Salads</h1>
                    ...
                    <p id="ps">Dressing Choices: Lemon Dijon Vinaigrette (vegan) or Tahini Garlic Dressing (non-vegan)</p>
            </div>
        </div>
    </section>
